...
3. **Побудування моделі.**
	...
	3. Модель взаємодії.
	![UseCase1](https://raw.githubusercontent.com/Miramif/ATM/master/Markdown/Pics/UseCase_1.png "UseCase chart")Модель показує взаємодію користувача та оператора з банкоматом та банком під час робочої сесії.
